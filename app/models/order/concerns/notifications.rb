...
module Order::Concerns
  ...
  module Notifications
    ...
    def deliver_receipt_notifications
      ...
      send_guest_order_receipt_email if user.phone_number != recipient_phone
    ...
    def deliver_processing_notifications
      ...
      send_order_processing_email(recipient_name) if user.phone_number != recipient_phone
      create_order_notification(@title, @body, @label)
      update(sent_processing_notification: true)
    ...
    def deliver_delivering_notifications
      ...
      send_order_delivering_email(recipient_name) if user.phone_number != recipient_phone
      create_order_notification(@title, @body, @label)
      update(sent_delivering_notification: true)
    ...
    def deliver_completed_notifications
      ...
      send_order_completed_email(recipient_name) if user.phone_number != recipient_phone
      create_order_notification(@title, @body, @label)
      update(sent_completed_notification: true)
